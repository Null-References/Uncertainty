...
public class InVision : Condition
{
    ...
    [Tooltip("cosine of degree between target and front if this object")]
    [Range(-1,1)]
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        var from = Quaternion.AngleAxis(-angle, center.up) * center.forward;
        Handles.DrawSolidArc(center.position,center.up,from,angle*2,radius);
    }
}